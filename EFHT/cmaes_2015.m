function cmaes_2015(strfitnessfct,stopfitness,psigma,VRmin,VRmax)
...
for N=5:5:30
    ...
    load(mat_name);
    %xmean =rand(N,1)*(VRmax-VRmin)+VRmin; % objective variables initial point
    %mat_name=['original_population_' strfitnessfct '_' num2str(N) '.mat'];
    %save(mat_name,'xmean');
    ...
    mu = 6; % lambda=12; mu=3; weights = ones(mu,1); would be (3_I,12)-ES
